...
namespace MyVirtualFactory.Infrastructure.Identity.Services
{
                ...
                if (result.Succeeded)
                {
                    if (request.IsCustomer)
                    {
                        Customer customer = new Customer()
                        {
                            ...
                            Name = user.FirstName,
                            CustomerUserId = await _userManager.GetUserIdAsync(user)
                        };
                    ...
                    else
                    {
                        ...
                        User staff = new User()
                        {
                            Name = user.FirstName,
                            LastName = user.LastName,
                            StaffUserId = await _userManager.GetUserIdAsync(user)
                        };
